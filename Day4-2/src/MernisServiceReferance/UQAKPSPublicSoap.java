...
public class UQAKPSPublicSoap
{
    ...
    public UQAKPSPublicSoap(){}

    public UQAKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UQAKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UQAExtendedSoapSerializationEnvelope envelope= new UQAExtendedSoapSerializationEnvelope(UQAExtendedSoapSerializationEnvelope.VER11);
