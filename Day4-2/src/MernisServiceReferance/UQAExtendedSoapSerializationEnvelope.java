...
public class UQAExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UQADateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UQAStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UQADateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UQADateTimeConverter dateTimeConverter = new UQAStandardDateTimeConverter();

    public UQAExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UQAExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UQAMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UQAHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UQAExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UQAHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
