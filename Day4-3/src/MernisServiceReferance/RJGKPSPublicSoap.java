...
public class RJGKPSPublicSoap
{
    ...
    public RJGKPSPublicSoap(){}

    public RJGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RJGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RJGExtendedSoapSerializationEnvelope envelope= new RJGExtendedSoapSerializationEnvelope(RJGExtendedSoapSerializationEnvelope.VER11);
