...
public class RJGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RJGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RJGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RJGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RJGDateTimeConverter dateTimeConverter = new RJGStandardDateTimeConverter();

    public RJGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RJGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RJGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RJGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RJGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RJGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
